...
class WanTI2VCausal:
    ...
    def t2v(self,
        ...
        # preprocess
        F = frame_num
        print("num_conditional_frames", num_conditional_frames)
        ...
        with (
            ...
            if cond_latent is not None:
                from fastvideo.models.wan.modules.block_attention import get_flex_causal_block_mask_for_prefill
            ...
            output_frames = []
            print("decode frame id", range(cond_latent_frame, T))
